                          ...
                          <tr>
                            ...
                            <form method="POST" action="" class="form-inline">
                              <td>
                                ...
                                <a href="event-list.php?id=<?php echo $row['events_id']; ?>" class="btn btn-sm btn-success text-white"><span class="fas fa-edit"></span></a>
                              </td>
...
if (isset($_POST['submit'])) {
  ...
  if ($result == TRUE) {
    ...
    $emailbody = '<b>' . $title . '</b><hr>' . $description.'<br> Event date: '.$event_date;
    include_once('../email.php');
    while ($row1 = mysqli_fetch_assoc($result1)) {
      sendEmail($emailbody, "NEW EVENT ADDED!", $row1['sub_email']);
    }
?>
    <script type="text/javascript">
