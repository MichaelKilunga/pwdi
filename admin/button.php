            ...
            <ul id="sidebarnav" class="pt-4">
             ...
             <li class="sidebar-item">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="voluntary-list.php"
                  aria-expanded="false"
                  ><i class="fas fa-users"></i
                  ><span class="hide-menu">Volunteer</span></a
                >
              </li>
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="subscribers-list.php"
                  aria-expanded="false"
                  ><i class="fas fa-bell"></i
                  ><span class="hide-menu">Subscribers</span></a
                >
              </li>

              <li class="sidebar-item">
                <a href="password.php" class="sidebar-link waves-effect waves-dark sidebar-link" 
