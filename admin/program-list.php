          ...
          <div class="card-body">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="date" class="form-control" placeholder="Enter date established" name="date_established" value="<?php echo $program['date_established']; ?>" required />
              </div>
                  ...
                  <table
                    ...
                    <thead>
                      <tr class="bg-success">
                        ...
                        <th class="text-white">Date Established</th>
                    ...
                    <tbody>
                      <?php
                      $sqli = "SELECT * FROM `program` AS p JOIN `category` AS c ON c.category_id=p.category_id ORDER BY p.date_established DESC,p.prog_status ASC, p.prog_name ASC";
                      ...
                      ?>
                          <tr>
                            ...
                            <td><?php echo $row['date_established']; ?></td>
                            <!-- <td> -->
                            <form method="POST" action="" class="form-inline">
                              <td>
                                <input type="text" name="sid" value="<?php echo $row['prog_id']; ?>" hidden>
                                <a href="program-list.php?id=<?php echo $row['prog_id']; ?>" class="btn btn-sm btn-success text-white"><span class="fas fa-edit"></span></a>
                              </td>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label>Established Date</label>
                      <input type="date" class="form-control" placeholder="Enter date established" name="date_established" required />
                    </div>
...
if (isset($_POST['submit'])) {
  ...
  $date_established = mysqli_real_escape_string($conn, $_POST['date_established']);

  $sqli = "INSERT INTO `program`(`category_id`, `prog_name`, `prog_description`, `prog_status`, `upload_date`, `date_established`) VALUES ('$category','$title','$description','$status','now()','$date_established')";
...
if (isset($_POST['edit'])) {
  ...
  $sqliep = "UPDATE `program` SET `category_id`='$category', `prog_name`='$title', `prog_description`='$description', `prog_status`='$status', `date_established`=' $date_established' WHERE prog_id='$_GET[id]'";
