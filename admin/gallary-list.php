                          ...
                          <tr>
                            ...
                            <form method="POST" action="">
                              <td>
                                ...
                                <a href="gallary-list.php?id=<?php echo $row['gallery_id']; ?>" class="btn btn-sm btn-success text-white"><span class="fas fa-edit"></span></a>
                              </td>
...
if (isset($_POST['submit'])) {
  ...
  if ($result == TRUE) {
    ...
    compressImage($_FILES['file']['tmp_name'], $path, $maxSize = 1048576, $quality = 90);
