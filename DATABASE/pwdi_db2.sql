...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2024 at 09:28 AM
...
(15, 'Reproductive health', '2024-11-28 13:22:18', 'Available'),
(16, 'Health Checkup', '2024-11-28 16:18:17', 'Available');
...
CREATE TABLE `contact-info` (
  ...
  `info_location` varchar(500) NOT NULL,
  `info_phone` varchar(500) NOT NULL,
  `info_altenativephone` varchar(500) NOT NULL,
  `info_email` varchar(500) NOT NULL,
  `info_altenativeemail` varchar(500) NOT NULL,
...
INSERT INTO `contact-info` (`info_id`, `info_location`, `info_phone`, `info_altenativephone`, `info_email`, `info_altenativeemail`, `info_address`, `info_date`) VALUES
(5, 'Soko kuu chifu Kingalu B.115', '+255 (0) 783 775 452', '+255 (0) 621 462 229', 'info@pwdi.or.tz', 'pwdi7@gmail.com', ' P.O. Box 1354 Morogoro Kingalu', '2024-11-29');
...
(15, 'Website Testing', ' Majaribio ya mara ya pili kwa kutuma email.', '2024-11-29', 'enable');
...
(17, 'Self Test - HIV', 16, 'HIV & AIDS, Malaria and TB awareness, counseling, support innovative programmes in orphans and vulnerable children and home based health care (HBC) for the HIV affected.HIV & AIDS, Malaria and TB awareness, counseling, support innovative programmes in orphans and vulnerable children and home based health care (HBC) for the HIV affected.', '../gallery/gallery-20241128_162145.jpeg', 'disable'),
(18, 'Massai Community Training', 6, 'PWDI believes that land rights and tenure security is a cornerstone for a sustainable pastoralists and farming communities living in harmony. To achieve that PWDI will undertake land rights and tenure security programs through capacity building interventions to community especially women, and youth. Formation of leadership forums and provision of Certificates of Customary Rights of Occupancy (CCROs) to individuals and groups of pastoralists.', '../gallery/gallery-20241128_163818.jpeg', 'enable'),
(19, 'trial', 11, 'trial image', '../gallery/gallery-20241129_112253.jpeg', 'enable');
...
CREATE TABLE `program` (
  ...
  `date_established` date NOT NULL DEFAULT '2023-12-12'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `program` (`prog_id`, `category_id`, `prog_name`, `prog_description`, `prog_status`, `upload_date`, `date_established`) VALUES
(2, 10, 'Ujasiriamali', 'Vijana kujihusidha na shughuli za ujasilimamali kama ilivyo ada kwa watu wetu.', 'enable', '2024-11-28 09:49:29', '2023-12-12'),
(4, 10, 'Financial', 'Linkages and collaboration with like minded organization .', 'enable', '2024-11-28 09:49:29', '2024-07-02'),
(7, 8, 'AVP Programs', 'Alternative to violence peace trainings (AVP) for the community members.', 'enable', '2024-11-28 09:49:29', '2024-11-15'),
(11, 10, 'Microfinance', 'Alternative to violence peace trainings (AVP) for the community members.', 'enable', '2024-11-28 09:49:29', '2023-12-12'),
(12, 11, 'Women and Men', 'Alternative to violence peace trainings (AVP) for the community members.', 'enable', '2024-11-28 09:49:29', '2023-12-12'),
(14, 6, 'School Clubs ', 'Establishment of environment and land rights school clubs,Programmes for cultural exchange, Community library for reading, borrowing and exchange of ideas. ', 'enable', '2024-11-28 09:49:29', '2025-01-03'),
(16, 9, 'Disability empowerment', 'Disability Establishment of environment and land rights school clubs, Programme for cultural exchange, Community library for reading, borrowing and exchange of idea.', 'enable', '2024-11-28 09:49:29', '2024-01-01'),
(20, 10, 'Youth Enterprenuership program', 'Youth empowerment', 'disable', '2024-11-28 09:49:29', '2023-12-12'),
(21, 15, 'Family planning', 'Family planning is the practice of controlling the number and timing of pregnancies, and it can include the treatment of infertility. It\'s a fundamental human right and a key strategy for improving family life and welfare', 'enable', '0000-00-00 00:00:00', '2024-08-08'),
(22, 9, 'Test', 'test purpose', 'enable', '0000-00-00 00:00:00', '2024-10-28'),
(23, 8, 'Gender education', 'Gender education for touth', 'enable', '0000-00-00 00:00:00', '2025-01-01'),
(24, 4, 'Youth Sports Training', 'Micezo jkasgbjsflbgksjlhgjskbgjklsbg kjbjskdfbjkbgjksbvgkj', 'enable', '0000-00-00 00:00:00', '2024-11-21'),
(25, 10, 'Email Testing', 'Youth empowerment activities such as sports, theatre, career development and drug abuse training, as well as building overall awareness and engagement through youth group projects..', 'enable', '0000-00-00 00:00:00', '2024-11-29'),
(26, 11, 'TUNAJARIBU PROGRAM', 'Hii ni program ya majaribio', 'enable', '0000-00-00 00:00:00', '2024-11-15');
...
(22, 'Empowerment', 'Youth empowerment activities such as sports, theatre, career development and drug abuse training.', 'disable', '../slides/slide-20241128_220248.jpeg'),
(30, 'Education', 'Mobilize community success school enrollment, Eco-tourism and environmental management.', 'enable', '../slides/slide-20241128_220535.jpeg'),
(31, 'Testing slider 2', 'Testing purpose', 'disable', '../slides/slide-20241126_150427.jpeg'),
(32, 'Massai Community Training', 'PWDI believes that land rights and tenure security is a cornerstone for a sustainable pastoralists and farming communities living in harmony. ', 'enable', '../slides/slide-20241128_173719.jpeg'),
(33, 'Fundraising', 'Use of women groups (VICOBA) ', 'enable', '../slides/slide-20241128_173739.jpeg');
...
(34, 'Catherine Peter', 'cathe@gmail.com', 'bbc1381a070e4864960b715e74ddeee2', 'No', 'Finance & admin officer', '../staff/user-20241101_141204.png', 'inactive'),
...
(38, 'williamtangwa95@gmail.com', 'inactive', '2024-11-20 17:59:25'),
(39, 'kaselebration368@gmail.com', 'inactive', '2024-11-20 17:59:35'),
(40, 'williamtangwa95@gmail.com', 'inactive', '2024-11-21 10:49:16'),
(41, 'grace@gmail.com', 'inactive', '2024-11-22 21:52:46'),
(42, 'williamtangwa95@gmail.com', 'inactive', '2024-11-28 22:17:09'),
(43, 'williamtangwa95@gmail.com', 'active', '2024-11-29 10:40:00'),
(44, 'micksimon30@gmail.com', 'active', '2024-11-29 10:58:08'),
(45, 'mickworks30@gmail.com', 'active', '2024-11-29 10:58:26'),
(46, 'williamtangwa95@gmail.com', 'active', '2024-11-29 11:13:37');
...
--
ALTER TABLE `events`
  MODIFY `events_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `program`
  MODIFY `prog_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
